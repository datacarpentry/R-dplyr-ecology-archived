...
> * being able to filter rows on a specific criterium
...
> Have a look at the [Introduction to dplyr](http://cran.rstudio.com/web/packages/dplyr/vignettes/introduction.html) for a hint.
...
>
> 1. Because the weight and hindfoot_length is not known for all data, you can first filter the data to see some more meaningful results.
